...
STORE_LOCATIONS: list[dict] = [
    ...
    {
        "chain":    "Giant Food",
        "location": "Giant Food — Charlottesville",
        "address":  "1600 Seminole Trail, Charlottesville, VA 22901",
        "lat":      38.0820,
        "lon":      -78.5010,
        "tier":     "mainstream",
        "zip":      "22901",
        "api_live": False,
        "note":     "Giant Card + Gas Rewards. Mid-Atlantic staple. PDF circular parses well.",
    },
    {
        "chain":    "Wegmans",
        "location": "Wegmans — Charlottesville",
        "address":  "Stonefield Town Center, Charlottesville, VA 22901",
        "lat":      38.0800,
        "lon":      -78.5025,
        "tier":     "mainstream",
        "zip":      "22901",
        "api_live": False,
        "note":     "Club card + app coupons. Digital-only circular — download as PDF from browser.",
    },
    {
