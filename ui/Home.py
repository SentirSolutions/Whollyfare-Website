    ...
    tiers = [
        {
            ...
            "next_tier": {"id": 2, "name": "Meal Planner", "price": "$9/mo", "teaser": "Ready to have five dinners planned for you every Sunday?"},
        },
        {
            "id": 2, "color": "#5DAA6A", "price": "$9", "price_sub": "/ month",
            "name": "Meal Planner", "badge": "Most popular", "cta": "Start planning",
            "tagline": "Five dinners planned around this week's best prices.",
            "features": ["Everything in Price Finder", "Weekly 5-dinner meal plan", "Flavor Plugins", "Sunday Buy-Off screen", "Shopping list by store", "Recipe & cuisine suggestions"],
        ...
        },
        {
            ...
            "features": ["Everything in Meal Planner", "Top-14 allergen hard filtering", "Celiac, MCAS, diabetes, CKD, IBS support", "Per-member household profiles", "Every rejection logged & explained", "Full recipes, cuisine memory & history", "Price history & savings tracking"],
